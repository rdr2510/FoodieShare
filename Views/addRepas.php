    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="modal-content">
            ...
            <div class="modal-body d-flex justify-content-center">
                <div class="w-75">
                    <div id="input" class="input-group mb-3 rounded">
                        ...
                        <input type="text" class="form-control" placeholder="Nom du plat" name="nom" require>
                    </div>
                    <div class="d-flex gap-lg-4 flex-column flex-lg-row">
                        <div id="input" class="input-group mb-3 rounded border-primary">
                            ...
                            <input type="number" class="form-control" step="any" aria-label="Prix unitaire du plat" placeholder="Prix Unitaire" name="prix" require>
                            <span class="input-group-text fw-bold">$</span>
                        </div>
                        <div id="input" class="input-group mb-3 rounded border-primary">
                            <span class="input-group-text material-symbols-rounded text-primary">distance</span>
                            <input type="number" class="form-control" step="any" aria-label="Prix unitaire du plat" placeholder="Localisation" name="localisation" require>
            ...
            <div class="modal-footer bg-secondary">
                ...
                <button type="submit" class="btn btn-primary d-flex align-items-center"><span class="material-symbols-rounded" style="margin-right: 10px;">cloud_upload</span>Enregistrer</button>
            </div>
        </form>
    </div>
</div>