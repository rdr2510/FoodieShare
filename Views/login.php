    <div class="d-flex justify-content-center align-items-center" style="height: 90%; width: 100%">
        <div id="login" class="d-flex justify-content-end position-relative" style="height: 440px">
            ...
            <div id="login-right" class="d-flex flex-column justify-content-center align-items-center bg-primary p-4">
                ...
                <div style="margin-top: 25px;">
                    <div id="user-connection" class="d-flex flex-column">
                        <button class="btn btn-primary btn-outline-light m-0 w-xl-100 d-flex align-items-center justify-content-center">SE CONNECTER<span class="material-symbols-rounded" style="margin-left: 8px;">login</span></button>
                        <a class="text-white text-center" style="margin-top: 15px;" href="#">Nouveau Compte</a>
                    </div>
                </div>
            </div>
        </div>
